...
class ZhihuHandlerMixin:
    ...
    async def parse_article(self, article_id: str):
        ...
        return self.result(
            ...
            stats={
                "likes": str(article.get("voteupCount") or ""),
                "comments": str(article.get("commentCount") or ""),
                "favorites": str(
                    article.get("favlistsCount")
                    or article.get("favoriteCount")
                    or ""
                ),
            },
    ...
    async def parse_answer(self, question_id: str, answer_id: str):
        ...
        return self.result(
            ...
            send_groups=send_groups,
            stats={
                "likes": str(answer.get("voteupCount") or ""),
                "comments": str(answer.get("commentCount") or ""),
                "favorites": str(
                    answer.get("favlistsCount")
                    or answer.get("favoriteCount")
                    or ""
                ),
            },
    ...
    async def parse_question(self, question_id: str):
        ...
        return self.result(
            ...
            send_groups=send_groups,
            stats={
                "views": str(question.get("visitCount") or ""),
                "answers": str(question.get("answerCount") or ""),
                "followers": str(question.get("followerCount") or ""),
            },
    ...
    async def parse_pin(self, pin_id: str):
        ...
        return self.result(
            ...
            stats={
                "likes": str(
                    payload.get("voteup_count") or payload.get("voteupCount") or ""
                ),
                "comments": str(
                    payload.get("comment_count") or payload.get("commentCount") or ""
                ),
            },
