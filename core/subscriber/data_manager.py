...
from .constants import DATA_PATH, DEFAULT_CFG, RECENT_DYNAMIC_CACHE
from ..render_html.models import SubscriptionRecord
...
class DataManager:
    ...
    def __init__(self, recent_dynamic_cache: int = RECENT_DYNAMIC_CACHE):
        ...
        standard_data_path = os.path.join(
            StarTools.get_data_dir(plugin_name="astrbot_plugin_parser"),
            "astrbot_plugin_parser.json",
        )
